          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <button
                ...
                className="bg-linear-to-r from-[#7ADB78]/80 to-[#AC6AFF]/80 hover:from-[#7ADB78] hover:to-[#AC6AFF] text-white px-6 py-2.5 rounded-lg font-semibold text-base transition-all transform hover:scale-105 shadow-lg flex items-center gap-2 border border-white/10"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                onClick={() => window.location.href = '/WealthPilot'}
                className="bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white px-6 py-2.5 rounded-lg font-semibold text-base transition-all transform hover:scale-105 shadow-lg flex items-center gap-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
