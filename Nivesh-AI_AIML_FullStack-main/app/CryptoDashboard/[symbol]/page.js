          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="h-full flex flex-col gap-6">
                ...
                <div className="bg-[#181f31] rounded-xl p-6 shadow-lg h-fit w-full">
                  <h3 className="text-xl font-bold mb-4 text-white border-b border-gray-700 pb-2">Compare Cryptos</h3>
